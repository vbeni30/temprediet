...
const commissionProjects: Project[] = [
  ...
  },
  {
    ...
    type: "photo",
    images: [
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a1.webp",
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a2.webp", 
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a3.webp",
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a4.webp",
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a5.webp", 
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a6.webp", 
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a7.webp",
      "/images/webp/04_Commisions/Except this time nothing returns from the ashes modeling/a8.webp",
    ],
  },
]
                ...
                <div className="rounded-lg overflow-hidden bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                    <div className="space-y-2">
                      <h3 className="text-base sm:text-lg font-light leading-tight text-black group-hover:text-emerald-500 transition-colors duration-300">
                        {project.title}
                      </h3>
